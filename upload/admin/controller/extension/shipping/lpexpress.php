...
class ControllerExtensionShippingLpexpress extends Controller { 
	...
	public function index() {  
		...
		$data['shipping_lpexpress_handlingactions'] = array($this->language->get('Per order'), $this->language->get('Per package'));
		...
		$data['action'] = $this->url->link('extension/shipping/lpexpress', 'user_token=' . $this->session->data['user_token'], 'SSL');
		...
		foreach ($geo_zones as $geo_zone) {
			...
			if (isset($this->request->post['shipping_lpexpress_' . $geo_zone['geo_zone_id'] . '_baseshippingprice'])) {
		
			$data['states'][ $geo_zone['geo_zone_id']]['baseshippingprice']=$this->request->post['shipping_lpexpress_' . $geo_zone['geo_zone_id'] . '_baseshippingprice'];
			} else {
			
			$data['states'][ $geo_zone['geo_zone_id']]['baseshippingprice'] = $this->config->get('shipping_lpexpress_' . $geo_zone['geo_zone_id'] . '_baseshippingprice');
			}


			if (isset($this->request->post['shipping_lpexpress_' . $geo_zone['geo_zone_id'] . '_priceperadditional'])) {
			
			$data['states'][ $geo_zone['geo_zone_id']]['priceperadditional'] = $this->request->post['shipping_lpexpress_' . $geo_zone['geo_zone_id'] . '_priceperadditional'];
			} else {
				
				$data['states'][ $geo_zone['geo_zone_id']]['priceperadditional'] = $this->config->get('shipping_lpexpress_' . $geo_zone['geo_zone_id'] . '_priceperadditional');
			}
			

			if (isset($this->request->post['shipping_lpexpress_' . $geo_zone['geo_zone_id'] . '_freeshippingfrom'])) {
			
			$data['states'][ $geo_zone['geo_zone_id']]['freeshippingfrom'] =  $this->request->post['shipping_lpexpress_' . $geo_zone['geo_zone_id'] . '_freeshippingfrom'];
			} else {
			
			$data['states'][ $geo_zone['geo_zone_id']]['freeshippingfrom'] = $this->config->get('shipping_lpexpress_' . $geo_zone['geo_zone_id'] . '_freeshippingfrom');
			}
			
			if (isset($this->request->post['shipping_lpexpress_' . $geo_zone['geo_zone_id'] . '_status'])) {
			
			$data['states'][ $geo_zone['geo_zone_id']]['status'] =$this->request->post['shipping_lpexpress_' . $geo_zone['geo_zone_id'] . '_status'];
			
			} else {
			$data['states'][ $geo_zone['geo_zone_id']]['status'] = $this->config->get('shipping_lpexpress_' . $geo_zone['geo_zone_id'] . '_status');
			}		
		}
		...
		if (isset($this->request->post['shipping_lpexpress_disableifhtml'])) {
			$data['shipping_lpexpress_disableifhtml'] = $this->request->post['shipping_lpexpress_disableifhtml'];
		} else {
			$data['shipping_lpexpress_disableifhtml'] = $this->config->get('shipping_lpexpress_disableifhtml');
		}
		if (isset($this->request->post['shipping_lpexpress_maxweight'])) {
			$data['shipping_lpexpress_maxweight'] = $this->request->post['shipping_lpexpress_maxweight'];
		} else {
			$data['shipping_lpexpress_maxweight'] = $this->config->get('shipping_lpexpress_maxweight');
		}
